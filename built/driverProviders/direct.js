		...
		switch (this.config_.capabilities.browserName) {
			...
			default:
				throw new exitCodes_1.BrowserError(
					logger,
					'browserName ' + this.config_.capabilities.browserName + ' is not supported with directConnect.'
				);
		}
	...
	getNewDriver() {
		...
		switch (this.config_.capabilities.browserName) {
			case 'chrome':
				...
				driver = require('selenium-webdriver/chrome').Driver.createSession(
					new selenium_webdriver_1.Capabilities(this.config_.capabilities),
					chromeService
				);
				break;
			case 'firefox':
				...
				driver = require('selenium-webdriver/firefox').Driver.createSession(
					new selenium_webdriver_1.Capabilities(this.config_.capabilities),
					firefoxService
				);
				break;
